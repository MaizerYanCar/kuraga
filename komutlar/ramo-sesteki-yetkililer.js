...
if(!["815971195685830658"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("ADMINISTRATOR"))) 
...
//-------------------------------------------------------------------------------\\
  ...
  message.guild.roles.cache.get("815971195685830658").members.map(r => {
